...
func init() {
	effectors = map[byte]effector{
		...
		bytecode.Typeof:  byteTypeof,
		bytecode.Modelof: byteModelof,
		bytecode.ToStr:   byteToStr,
		bytecode.ToNum:   byteToNum,
		bytecode.ToList:  byteToList,
		bytecode.ToTuple: byteToTuple,
